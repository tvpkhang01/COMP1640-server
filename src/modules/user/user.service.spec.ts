...
describe('UserService', () => {
  ...
  describe('create', () => {
    it('should create a new user', async () => {
      ...
      jest
        ...
        .mockResolvedValueOnce(expectedResult.user);
  ...
  describe('remove', () => {
    it('should remove user and associated contributions and comments', async () => {
      ...
      const softDeleteContributionSpy = jest
  ...
  describe('deleteOldAvatar', () => {
    it('should delete old avatar if user has one', async () => {
      ...
      jest
        .spyOn(cloudinaryService, 'extractPublicIdFromUrl')
        .mockReturnValue(publicId);
  ...
  describe('uploadAndReturnUrl', () => {
    it('should upload and return URL', async () => {
      ...
      jest
        .spyOn(cloudinaryService, 'uploadImageFile')
